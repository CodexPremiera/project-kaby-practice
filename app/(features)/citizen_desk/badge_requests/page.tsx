...
import { profiles as profileData } from "@/data/profiles"; // 👈 directly import here
	...
	return (
		<div className="pt-1">
			<div className="flex flex-col mb-4 gap-2 m-7">
				<div className="h5">Badge Request</div>
				...
				<table className="min-w-full divide-y divide-gray-200 text-sm">
					<thead>
						<tr>
							...
							<th className="py-2 px-2 text-left h6 whitespace-nowrap">Date</th>
							<th className="py-2 px-2 text-left h6 whitespace-nowrap">
								Action
							</th>
						</tr>
					...
					<tbody className="divide-y divide-gray-100">
						{filteredProfiles.map((profile, index) => (
							<tr key={index}>
								...
								<td className="px-2 whitespace-nowrap">04/23/2025</td>
