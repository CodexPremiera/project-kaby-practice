...
const TAB_LABELS: Record<keyof typeof TAB_COMPONENTS, string> = {
	...
	Reports: "Reported users"
};

const CitizenDesk = () => {
	const [activeTab, setActiveTab] = useState<keyof typeof TAB_COMPONENTS>("Dashboard");
	...
	return (
		<div className="flex relative w-full justify-center">
			...
			<div className="main flex flex-col xl:flex-row items-start w-full max-w-[1440px] mx-auto gap-6 xl:gap-8">
				{!isLargeScreen && (
