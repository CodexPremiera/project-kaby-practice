...
const NAVIGATION_ITEMS = [
	{ name: "Home", path: `/citizen`, icon: RiCommunityLine },
	{ name: "Service Desk", path: `/citizen/service_desk`, icon: RiInboxLine },
	{ name: "Tracker", path: `/citizen/tracker`, icon: RiAlarmWarningLine },
	{ name: "Settings", path: `/citizen/account`, icon: RiSettings4Line },
];
