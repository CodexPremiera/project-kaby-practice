...
const BarangayProfileTab = () => {
	...
	return (
		<div className="flex flex-col lg:flex-row w-full rounded-3xl px-8 pt-8 pb-6 lg:py-4 gap-6 items-center justify-between background-1 border-light-color border">
			{/* Profile Section */}
