	...
	return (
		<DayPicker
			...
			classNames={{
				...
				day_selected:
					"bg-secondary text-secondary-foreground hover:bg-gray-200 hover:text-secondary-foreground focus:bg-secondary focus:text-secondary-foreground",
				day_today: "border-secondary text-secondary-foreground",
				day_outside:
